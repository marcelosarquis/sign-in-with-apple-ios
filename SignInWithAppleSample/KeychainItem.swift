...
struct KeychainItem {
    ...
    static var currentUserIdentifier: String {
        do {
            let storedIdentifier = try KeychainItem(service: "com.binarieslab.SignInWithAppleSample", account: "userIdentifier").readItem()
    ...
    static func deleteUserIdentifierFromKeychain() {
        do {
            try KeychainItem(service: "com.binarieslab.SignInWithAppleSample", account: "userIdentifier").deleteItem()
        } catch {
